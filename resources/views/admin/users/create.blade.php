        ...
        <div class="card-body">
            ...
            <form class="forms-sample" action="{{ route('admin.users.store') }}" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="email" value=""  class="form-control" id="exampleInputEmail3" placeholder="Email">
                </div>
                
                <div class="form-group">
                    <label for="exampleInputEmail3">Password</label>
                    <input type="text" name="password" value=""  class="form-control" id="exampleInputEmail3" placeholder="Nhập ảnh">
                </div>
